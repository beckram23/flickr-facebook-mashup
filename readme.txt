...
Also mouse coordinates of the moucse click is obtained to set the position of the bigger image above it.
Once the enlarged image is displayed, the upload button is enabled to upload the image to Facebook.
Using appropiate Facebook methods, a dialog is shown asking whether to publish the image(if the user has already logged 
